...
- [암묵적 타입 변환이란](#암묵적-타입-변환이란)
- [문자열 타입으로의 변환](#문자열-타입으로의-변환)
- [숫자 타입으로의 변환](#숫자-타입으로의-변환)
  - [산술 연산자와 숫자 타입으로의 형변환](#산술-연산자와-숫자-타입으로의-형변환)
  - [비교 연산자와 숫자 타입으로의 형변환](#비교-연산자와-숫자-타입으로의-형변환)
    - [동등/일치 비교 연산자](#동등/일치-비교-연산자)
    - [대소 관계 비교 연산자](#대소-관계-비교-연산자)
- [불리언 타입으로의 변환](#불리언-타입으로의-변환)
  - [제어문에서의 형변환](#제어문에서의-형변환)
  - [삼항 조건 연산자 조건식에서의 형변환](#삼항-조건-연산자-조건식에서의-형변환)
  - [논리 연산자에서의 형변환](#논리-연산자에서의-형변환)
  - [비교 연산자와의 형변환 차이](#비교-연산자와의-형변환-차이)
